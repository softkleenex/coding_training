---
title: "Kaggle 대회 아카이브"
description: "Softkleenex Archive의 Kaggle 대회 포트폴리오입니다. AI 대회 회고, 병목, 해결 과정, GitHub 저장소와 실험 운영 기록을 정리합니다."
tags:
  - AI
  - Kaggle
  - Competition
...
Kaggle 대회와 관련 실험을 정리하는 포트폴리오 아카이브입니다.
모델 코드만 남기기보다, 대회마다 막혔던 지점, 해결 방식, 제출 운영에서 배운 점을 함께 남기는 것이 목표입니다.

> [!info] 연결 원칙
> 원본 코드와 산출물은 각 repo에서 관리하고, 블로그는 회고와 탐색을 위한 입구로 유지합니다.

## 대표 링크

- [ARC Prize 2025: Abstract Reasoning Challenge](./kaggle-arc-prize-2025)
- [한화생명 미래금융인재 공모전 - LifeTwin AI](./hlftc)
...
| [MedGemma Clinical RAG Pipeline](./kaggle-medgemma-clinical-rag-pipeline)              | [kaggle-medgemma-clinical-rag-pipeline](https://github.com/softkleenex/kaggle-medgemma-clinical-rag-pipeline) | RAG/의료          |
| [RNA 3D Structure Prediction](./kaggle-stanford-rna-3d-folding-2)                      | [kaggle-stanford-rna-3d-folding-2](https://github.com/softkleenex/kaggle-stanford-rna-3d-folding-2)           | 구조예측/MLOps    |
